...
class SendSms(): #YILDIRIMLORD1REM
    adet = 0
    ...
    def Dolap(self):
        try:
            ...
            json={"advertisingId": "", "campaignAgreement": False, "email": self.mail, "memberCookie": "", "membershipAgreement": True, "nickName": "Codex", "password": "31ABC..abc31", "phoneNumber": self.phone}
